...
def localize(args):
    ...
    for bug in swe_bench_data:
        ...
        if args.file_level:
            ...
            # if args.add_gt_file:
            #     swe_agent_gt_path = '/home/ubuntu/OpenDevin/evaluation/swe_bench/swe_agent_gt_file.json'
            #     with open(swe_agent_gt_path, 'r') as file:
            #         swe_agent_gt_files = json.load(file)
            #     gt_file = swe_agent_gt_files[d["instance_id"]]['edited_file']
            #     if gt_file not in found_files:
            #         found_files.insert(0,gt_file)
            #         found_files = found_files[:5]
            # if args.only_gt_file:
            #     swe_agent_gt_path = '/home/ubuntu/OpenDevin/evaluation/swe_bench/swe_agent_gt_file.json'
            #     with open(swe_agent_gt_path, 'r') as file:
            #         swe_agent_gt_files = json.load(file)
            #     gt_file = swe_agent_gt_files[d["instance_id"]]['edited_file']
...
def main():
    ...
    parser.add_argument("--add_gt_file", action="store_true")
    parser.add_argument("--only_gt_file", action="store_true")
